...
public class ControllerLog {
    ...
    @Pointcut("execution(public * site.minnan.mp.userinterface.fascade..*..*(..))")
    private void controllerLog() {
    }

    @Pointcut("execution(public * site.minnan.mp.userinterface.fascade.PageController..*(..))")
    private void pageRequest(){}


    @Around("controllerLog() && !pageRequest()")
